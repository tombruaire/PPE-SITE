<div class="container mt-4">
	<div class="row d-flex justify-content-center">
		<div class="col-auto">
			<div class="card rounded border border-5 border-warning reveal-1">
				<div class="card-body bg-light">
					<h3 class="text-center">
						Liste des associations de la Mairie de Villiers
					</h3>
				</div>
			</div>
		</div>
	...
	<div class="d-flex justify-content-center">
		<div class="col-md-auto col-xxl-10">
			<div class="card reveal-2">
				<div class="card-body bg-light rounded border border-5 border-warning">
					<table id="datatables-reponsive" class="table text-center table-dark table-striped" style="width:100%">
						<thead>
							<tr>
								<td><i class="align-middle fas fa-fw fa-home fs-3"></i></td>
						...
						<tbody>
							<?php
							$view = $bdd->query('SELECT nomassoc, siegeassoc, date_format(datecreationassoc, "%e/%m/%Y"), inscrits FROM associations;');
							...
							<tr>
								...
								<td><?= $donnees['date_format(datecreationassoc, "%e/%m/%Y")'] ?></td>
							</tr>
							<?php } ?>
						</tbody>
					</table>
	      		...
	      		<div class="modal-body">
                    ...
                    <div class="mb-3">
                        <select name="association" class="form-select form-control-lg fw-bold">
                            ...
                            <option value="<?= $unEvenement['nomassoc'] ?>"><?= $unEvenement['nomassoc'] ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="d-flex justify-content-center">
        ...
        <div class="col-auto">
            <div class="alert alert-primary alert-dismissible reveal-3" role="alert">
                <div class="alert-message">
                    ...
                    <a href="connexion">Connectez-vous</a> ou <a href="inscription">inscrivez-vous</a> pour vous inscrire à une associations.
                </div>
            </div>
        </div>
    </div>
